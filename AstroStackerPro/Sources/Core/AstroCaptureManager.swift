...
enum StackingMethod: String, CaseIterable, Identifiable { case maximum, average; var id: String { rawValue } }
enum CameraType: String, CaseIterable, Identifiable { case wide = "Grandangolo", ultraWide = "Ultra‑grandangolo", telephoto = "Tele"; var id: String { rawValue } }
...
final class AstroCaptureManager: NSObject, ObservableObject {
    ...
    @Published var cameraType: CameraType = .wide { didSet { reconfigureForCamera() } }
    ...
    // Calibrazione
    private var darkBuffers: [CVPixelBuffer] = []
    private var flatBuffers: [CVPixelBuffer] = []
    private var biasBuffers: [CVPixelBuffer] = []
    ...
    // Placeholder calibrazioni
    func startDarkFrameCapture(seconds: Int) { /* TODO */ }
    func startFlatFrameCapture(seconds: Int) { /* TODO */ }
    func startBiasFrameCapture(count: Int) { /* TODO */ }
    ...
    private func reconfigureForCamera() { /* TODO */ }
}
